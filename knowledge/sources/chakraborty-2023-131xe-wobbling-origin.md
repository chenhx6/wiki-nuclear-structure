...
citation_key: chakraborty_2023_Search
...
| C23-2 | 671、882、1055、1176 keV 为 dipole，705、766、816、930 keV 为 quadrupole；1055 keV 的 δ 接近 0，671/882 keV 的 δ 分别约 0.03(3)/0.09(8)。 | experimental-fact | direct | PDF pp.3-4, Table I, Figs.4-5 | true |
...
| C23-5 | yrare 17/2- 态实验 `B(M1)/B(E2)=1.27(14)` 与 TPRM 1.27 一致；yrast 17/2- 的实验值 2.54(4) 约为模型值两倍。 | experimental-fact | direct | PDF p.7 | true |
