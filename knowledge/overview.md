...
| 页面级 unreviewed | 56 | 自动 lint governance 统计 |
| source 页 unreviewed | 1 | De Voigt 1983 source 待页面级人工审阅 |
| 页面级 needs-human-review | 0 | 不等同于 claim-level 待审数量 |
| claim-level `needs_review: true` | 12 | 旧 9 条 + De Voigt 1983 新增 3 条 |
...
| 自动 lint | 0 error / 1 warning / 12 info | warning 为用户 BibTeX 工作树修改；12 info 为 claim-level 待审项 |
