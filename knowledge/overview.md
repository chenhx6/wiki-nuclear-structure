...
| claim-level `needs_review: true` | 5 | 当前 144 条结构化 claims；Guo/Lv supplementary material 新增 5 条待审 |
...
| 自动 lint | 0 error / 10 warning / 5 info | warning 含用户 BibTeX、未配置元素与 `1p4n` 解析提示；info 为 5 条补充材料待审 claims |
