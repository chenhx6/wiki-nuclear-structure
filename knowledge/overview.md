...
| 指标 | 当前值 | 说明 |
|---|---:|---|
| 正式来源数 | 15 | `knowledge/sources/`；新增 Lawrie 2020 TiP/wobbling theory source |
...
| 页面级人工审阅页 | 24 | 15 个 source 页 + 9 个其他知识页；Lawrie 2020 source 已审 |
| 页面级 unreviewed | 78 | 自动 lint governance 统计；TiP concept 仍待审 |
| source 页 unreviewed | 0 | 15 个 source 页均完成人工页面级审阅 |
| 页面级 needs-human-review | 0 | 不等同于 claim-level 待审数量 |
| claim-level `needs_review: true` | 0 | 当前 159 条结构化 source claims 均已完成用户确认 |
...
| 断裂链接 | 0 | 931 个 Wikilink 已检查 |
| Raw 哈希异常 | 0 | 15/15 个来源页与原文件一致 |
