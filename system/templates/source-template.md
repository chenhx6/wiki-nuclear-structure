...
仅在有科学价值时填写；不得与作者明示内容混写。下表是审核界面，不是固定产量配额：没有可靠内容的项目应写“不适用/不创建”并说明理由，不得补造。每行必须把 Agent 判断与 source evidence / locator 分开，保留关键假设、适用边界和不确定性。复杂跨来源推理应进入受控 research-note 或 synthesis，不强迫压入单个表格单元格。
