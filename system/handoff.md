...
- 已以 commit `e7b08a2`（`Ingest Guo 2022 counter-evidence for 187Au wobbling`）提交并推送至 `origin/main`；`.obsidian/graph.json` 与 `raw/zotero/wiki-inbox.bib` 未纳入。下一步继续审核 G22-1、G22-2、G22-5 至 G22-14、G22-16、G22-17。
