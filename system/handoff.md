...
## 当前执行：Nomura 2022 IBFM low-spin wobbling alternative（source 审核完成；project notes 待审）
...
- 当前待审重点转为 project-level notes：P0 为 LSW-IBFM-2 与 GSD-PROJ-7（Table II 外推边界、`127Xe` 例外与“γ-soft background 不决定 band identity”的 source→project 约束）；P1 为 LSW-IBFM-1/3/4。
