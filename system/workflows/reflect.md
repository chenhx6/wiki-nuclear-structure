...
重用旧 project/synthesis 时，只对本轮实际使用且确有必要的部分做最小 on-touch migration；仅有格式差异不触发机械重写，不批量补历史字段或转换旧 Personal Notes。任何新的科学判断、竞争解释、结论或状态变化继续进入 Human review triage。
